...
И во втором варианте он исчезает.

..
  Третья причина заключается в том, что становится многословней реализация экспортеров-запросов к БД для композитных ValueObject.
